...
<br> <b>Features:</b>
 - Registration with JWT token authorization and encryption
 - Customizing user profiles
 - Following other users and being followed by them
 - Searching the book database with real-time autocomplete
 - Browsing detailed book data, including reviews from other users
 - Organizing books on virtual shelves to represent the user's real collection
 - Reviewing books and posting reading statuses
 - Browsing the main page to see the activity of followed users
 - Viewing other users' profiles to see their activity and shelves <br><br>
